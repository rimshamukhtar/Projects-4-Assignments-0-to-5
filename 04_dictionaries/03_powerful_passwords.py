...
def login(email, stored_logins, password_to_check):
    """
    Yeh function check karta hai agar given email ka stored password hash 
    password_to_check ke hash ke barabar ho to login successful hai.
    """
...
def hash_password(password):
    """
    Yeh function password ko SHA256 algorithm se hash karta hai aur hash return karta hai.
    """
    return sha256(password.encode()).hexdigest()

def main():
    # Stored logins dictionary jisme emails aur hashed passwords hain
    stored_logins = {
